...
public class BestResident extends javax.swing.JPanel {
    ...
    public ArrayList<ResidentEmployee> calculateTopThreeCitizenByRewardPoints(ArrayList<ResidentEmployee> citizenList){
       ...
       ResidentEmployee ce3 =   new ResidentEmployee();
        ...
        for(ResidentEmployee ce : citizenList){
...
//            }
        ...
        ArrayList<ResidentEmployee> residentEmployee = calculateTopThreeCitizenByRewardPoints(residentEmployeeList);
        

        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.setValue(residentEmployee.get(0).getCurrentRewardPoints(), "Citizens", residentEmployee.get(0).getName());
        dataset.setValue(residentEmployee.get(1).getCurrentRewardPoints(), "Citizens", residentEmployee.get(1).getName());
        dataset.setValue(residentEmployee.get(2).getCurrentRewardPoints(),  "Citizens", residentEmployee.get(2).getName());
